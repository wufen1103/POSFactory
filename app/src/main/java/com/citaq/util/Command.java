...
public class Command {
	...
	public static byte[] openCash = new byte[] { 0x1B, 0x70, 0x00, (byte) 0x80, (byte) 0x80 };
//	public static byte[] openCash2 = new byte[] { 0x1B, 0x70, 0x00, (byte) 0x50, (byte) 0x50 };  //F15
	
	public static byte[] cutPaper =  new byte[] {0x20,0x0A, 0x1D, 0x56, 0x42, 0x00 }; // 切纸； GS V  66D 0D
	...
	public static byte[] getPrintDemo() {
		...
		strTmp = "3.00\n";
		oldText = setCusorPosition(552 - 160 - 12 * strTmp.length());
		System.arraycopy(oldText, 0, printText, iNum, oldText.length);
		iNum += oldText.length;
		...
		strTmp = "10 79.00\n";
		oldText = setCusorPosition(552 - 250 - 2 * strTmp.length());
		System.arraycopy(oldText, 0, printText, iNum, oldText.length);
		iNum += oldText.length;
